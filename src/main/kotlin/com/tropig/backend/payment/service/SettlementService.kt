    ...
    fun createSettlement(authMember: AuthMember, request: CreateSettlementRequest): SettlementResponse {
        ...
        val transferRequest = PlatformCreateManualTransferRequest(
            ...
            request.memo
                ...
                ).year}년 ${LocalDate.now(ZoneId.of("Asia/Seoul")).monthValue}월 정산",
        )
        ...
        val settlement = CreatorSettlement(
            ...
            description = "정산 - ${request.memo ?: "${LocalDate.now(
                ZoneId.of("Asia/Seoul"),
            ).year}년 ${LocalDate.now(ZoneId.of("Asia/Seoul")).monthValue}월 정산"} (Transfer ID: ${transferResponse.id})",
        )
